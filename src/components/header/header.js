                        ...
                        <div className="nav_header" >
                          ...
                          {this.state.width>768?
                                <div className="header_Right">
                                            ...
                                            <Link to='/medicine' className="Header_list">
                                                <span>产品介绍</span>
                                            </Link>
                                            <Link to='/doctor' className="Header_list">
                                                <span>关于我们</span>
                                            </Link>
                                            <Link to='/sale' className="Header_list">
                                                <span>品牌故事</span>
                                            </Link>
                                ...
                                {this.state.ListShow?
                                    <div  style={{width:this.state.width,height:this.state.height,}} className={this.state.animation? "nav show":"nav hide"} >
                                        ...
                                        <div >
                                            ...
                                            <Link to='/sale' className="content_list">
                                                <span>品牌故事</span>
                                              
                                            </Link>
                                            <Link to='/aboutus' className="content_list" >
                                                <span>联系我们</span>
