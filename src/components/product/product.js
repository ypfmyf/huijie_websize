                       ...
                       <div className={this.state.width>768? 'con_header con_header_PC':'con_header'}>
                           <div>
                                <div  className={this.state.width>768? 'header_H header_H_PC':'header_H'}>
                                    ...
                                    <span style={{fontSize:this.state.width>768? '20px':'1.12rem',color:'#333333',}}>产品介绍</span>
                                    <img src="./image/product/pic@2x.png"></img>
                                </div>
                                <div style={{fontSize:this.state.width>768? '14px':'0.8rem',color:'#999999',textAlign:'center',marginTop:this.state.width>768? '14px':'0.53rem'}}>Product Description</div>
                            ...
                            {this.state.width>768?
                                <div>
                                    {this.state.productList.map((data,index) => {
                                        return (
                                                    <div className="proList_PC">
                                                        <img src={data.proImage} style={{width:'400px',height:'400px',}}></img>
                                                        <div style={{flex:1,marginLeft:'73px',}}>
                                                            <div className='pro_con_con_PC'>
                                                                <div style={{fontWeight:'bold'}}>{data.proName}</div>
                                                                <div style={{fontSize:'16px',color:'#666666',marginTop:'30px'}}>{data.proAdvertising}</div>
                                                            </div>
                                                            <div className="pro_con_Bor pro_con_Bor_PC"></div>
                                                            <div className="pro_con_introduce pro_con_introduce_PC">
